...
namespace quasiforum.Services.Migrations
{
    ...
    [Migration("20220812091952_renaming_topic")]
    partial class renaming_topic
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("collectIO.Models.Post", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("collectIO.Models.Topic", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("collectIO.Models.Comment", b =>
                {
                    b.HasOne("collectIO.Models.Post", "CommentedItem")
            ...
            modelBuilder.Entity("collectIO.Models.Post", b =>
                {
                    b.HasOne("collectIO.Models.Topic", "ParentTopic")
                        .WithMany("Items")
